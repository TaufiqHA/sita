...
class JadwalUjian extends Page implements HasInfolists
{
    use InteractsWithInfolists;
    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.mahasiswa.pages.jadwal-ujian';
    ...
    public function mount(): void
    {
        ...
        $this->record = Ujian::where('user_id', $this->mahasiswa)->first();
    }

    public function infolistJadwalUjian(Infolist $infolist): Infolist
    {
