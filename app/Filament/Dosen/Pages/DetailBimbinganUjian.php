...
class DetailBimbinganUjian extends Page implements HasForms
{
    use InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.dosen.pages.detail-bimbingan-ujian';
    ...
    public function mount(Request $record): void
    {
        ...
        $this->editStatusForm->fill(PembimbingUjian::where('mahasiswa_id', $record->record)->first()->attributesToArray());
        $this->bimbingan = PembimbingUjian::where('mahasiswa_id', $record->record)->first();
    }
    ...
    public function save()
    {
        ...
        return redirect(ListMahasiswaBimbinganUjian::getUrl());
    }
}
