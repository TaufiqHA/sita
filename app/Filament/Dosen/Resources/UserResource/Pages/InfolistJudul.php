...
class InfolistJudul extends Page implements HasInfolists, HasForms
{
    use InteractsWithInfolists;
    use InteractsWithForms;
    protected static string $resource = UserResource::class;

    protected static string $view = 'filament.dosen.resources.user-resource.pages.infolist-judul';
    ...
    {
        $this->record = BimbinganProposal::where('user_id', $record)->first();
        $this->dosen = Auth::user()->id;
        $this->form->fill(BimbinganProposal::where('user_id', $record)->first()->attributesToArray());
    }
 
    public function infolistJudul(Infolist $infolist): Infolist
    {
        return $infolist
            ->record($this->record)
            ->schema([
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->success()
            ->title('Proposal Telah Disetujui')
            ->send();
    }
