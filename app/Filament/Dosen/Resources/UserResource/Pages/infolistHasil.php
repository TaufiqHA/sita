...
class infolistHasil extends Page implements HasForms, HasInfolists
{
    use InteractsWithForms;
    use InteractsWithInfolists;
    protected static string $resource = UserResource::class;

    protected static string $view = 'filament.dosen.resources.user-resource.pages.infolist-hasil';

    protected static ?string $title = "Infolist Bimbingan Hasil";
    ...
    {
        $this->record = BimbinganHasil::where('user_id', $record)->first();
        $this->dosen = Auth::user()->id;
        $this->form->fill(BimbinganHasil::where('user_id', $record)->first()->attributesToArray());
    }
    ...
    public function save(): void
    {
        ...
        Notification::make()
            ->success()
            ->title('Bimbingan Hasil Telah Disetujui')
            ->send();
    }
